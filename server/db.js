...
ensureColumn('writer_settings', 'spellcheck_mode', "TEXT DEFAULT 'local'");
ensureColumn('characters', 'body_type', "TEXT DEFAULT 'medio'");
ensureColumn('characters', 'height_cm', 'INTEGER DEFAULT 170');
ensureColumn('characters', 'gender', "TEXT DEFAULT ''");
ensureColumn('characters', 'skin_tone', "TEXT DEFAULT '#c68863'");
ensureColumn('characters', 'hair_color', "TEXT DEFAULT '#2b1a12'");
ensureColumn('characters', 'hair_style', "TEXT DEFAULT 'curto'");
ensureColumn('characters', 'eye_color', "TEXT DEFAULT '#4a3728'");
ensureColumn('characters', 'outfit_color', "TEXT DEFAULT '#3a2c1f'");
